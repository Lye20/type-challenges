...
type CombinationUnion<T extends string, U extends string = T> = T extends T
  ? T | `${T} ${CombinationUnion<Exclude<U, T>>}`
  : never
type Combination<T extends string[]> = CombinationUnion<T[number]>
